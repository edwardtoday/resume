...
\section{教育经历}
\cventry{2007--2010}{经济学 学士}{清华大学}{北京}{}{主修课程：经济学原理、中级宏观经济学、中级微观经济学、产业组织理论、货币银行学、中国经济专题}
...
\cventry{2009}{市场部实习生}{上海恩德斯豪斯自动化设备有限公司}{上海}{}
{
\begin{itemize}
...
\section{掌握技能}
\cvitemwithcomment{计算机}{熟练运用Office各办公组件}{掌握计算机辅助数据分析，能够编写程序解决实际问题}
\cvitemwithcomment{英语}{CET-6 652, TOEFL 107}{英语流利对话、读写，曾在国家级、省级英语竞赛获奖}
\cvitemwithcomment{驾驶}{C1驾照}{无扣分记录、无事故记录}
\cvitem{摄影}{帮多位朋友同学拍摄证件照、肖像，以及我自己的外景婚纱照}
\cvitem{摄像}{07年担任赴四川社会调研团队摄像师，近年多次制作视频短片}
\cvitem{唱歌}{爱好唱歌，学生时代一直参加合唱队，初中曾获市一等奖，大学多次登台演出}
